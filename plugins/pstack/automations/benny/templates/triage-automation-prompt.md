...
> Source material for the copied setup workflow. Paraphrase this intent into the prompt of a scheduled automation (`CronCreate`) once the copied pack is committed in the repository where the automation will run.
