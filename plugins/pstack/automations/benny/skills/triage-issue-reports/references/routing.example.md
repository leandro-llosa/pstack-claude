...
Copy this file outside `.zcode/automations/benny/`, for example to `.zcode/benny/routing.md`, and replace every placeholder. Point `routing.map_path` at the copy. Pack refreshes must not overwrite it.
