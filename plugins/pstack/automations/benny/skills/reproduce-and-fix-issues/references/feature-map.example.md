...
Copy this file outside `.zcode/automations/benny/`, for example to `.zcode/benny/feature-map.md`, and set `control.feature_map_path` to the copy. Pack refreshes must not overwrite it.
