...
**Platform note.** On Codex, the `comment-sicko` subagent and the Claude tool names below are Claude defaults. Resolve them via [`codex-tools.md`](../poteto-mode/references/codex-tools.md). On ZCode, resolve them via [`zcode-tools.md`](../poteto-mode/references/zcode-tools.md).
